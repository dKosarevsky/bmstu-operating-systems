...
static const char *kmodule_proc_ent = "fortune";
static const char *kmodule_proc_dir = "fortune_dir";
static const char *kmodule_proc_sym_des = "fortune_dir/fortune_sym";
static const char *kmodule_proc_sym_tar = "/proc/fortune";
